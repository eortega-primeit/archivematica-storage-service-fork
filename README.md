...
* [Case studies repo]: for a collection of resources about work on and with
  Archivematica
...
For more projects in the Archivematica ecosystem, see the [dependencies] page
on the [Contributors Portal].
